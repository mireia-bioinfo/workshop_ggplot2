...
This should really be the first and **last** time you produce this kind of plot! `r icon::fa("grin-tongue-wink")`
...
## Saving your `ggplot2` graphs `r icon::fa("save", pull="left")`
